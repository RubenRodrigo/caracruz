...
function getColor(e) {
    var color = e.parentElement.querySelector('.producto-colores .colores--prenda#active button')    
    console.log("COLOR",color);
    return color.dataset.color
}
function getQuantity(e) {
    var quantity = e.parentElement.querySelector('.producto-cantidad .cantidad')    
...
function updateUserOrder(productId, action, colorId, sizeId, quantity)  {
    ...
    .then((data) => {
        ...
        var carrito_cantidad = document.querySelector('.cart-cantidad')
